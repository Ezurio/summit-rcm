...
class SummitRcmFalconAsgiPlugin(BasePlugin):
    """
    *** Summit RCM port of the Falcon ASGI plugin for Spectree ***
    ...
    def __init__(self, spectree):
        ...
        self._validate_request: bool = ServerConfig().validate_request
        self._validate_response: bool = ServerConfig().validate_response
    ...
    async def validate(
        ...
        **kwargs: Any,
        ...
        if (
            ...
            and not self._data_set_manually(_resp)
