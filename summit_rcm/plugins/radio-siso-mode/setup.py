...
packages = []
environment_variable_value = os.environ.get("SUMMIT_RCM_RADIO_SISO_MODE_PLUGIN_EXTRA_PACKAGES", "")
...
def get_cython_options():
    ...
    modules_to_exclude = ["summit_rcm_radio_siso_mode.rest_api.utils.spectree.models"]
...
def run_setup(CYTHON):
    ...
    setup(
        name="summit-rcm-radio-siso-mode-plugin",
        cmdclass=cmdclass,
        version="1.0",
        packages=packages,
