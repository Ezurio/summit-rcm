...
def get_cython_options():
    ...
    modules_to_exclude = [
        "summit_rcm_provisioning.rest_api.utils.spectree.models",
        "summit_rcm_provisioning.rest_api.utils.spectree.tags",
    ]
...
def run_setup(CYTHON):
    ...
    setup(
        name="summit-rcm-certificate-provisioning-plugin",
        cmdclass=cmdclass,
        version="1.0",
        packages=packages,
