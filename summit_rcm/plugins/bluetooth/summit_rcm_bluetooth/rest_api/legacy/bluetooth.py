...
try:
    ...
    from summit_rcm_bluetooth.rest_api.utils.spectree.models import (
        BluetoothStateResponseModelLegacy,
        BluetoothStateQueryModel,
        BluetoothControlRequestModel,
        BluetoothControlResponseModelLegacy,
    )
    ...
    BluetoothStateResponseModelLegacy = None
    BluetoothStateQueryModel = None
    BluetoothControlRequestModel = None
    BluetoothControlResponseModelLegacy = None
    bluetooth_tag = None
...
class BluetoothLegacyResource:
    ...
    @spec.validate(
        ...
        resp=Response(
            HTTP_200=BluetoothStateResponseModelLegacy,
    ...
    async def on_get(self, req, resp):
        """
        Retrieve the state of all Bluetooth controllers and devices (legacy)
        """
    ...
    @spec.validate(
        ...
        resp=Response(
            HTTP_200=BluetoothControlResponseModelLegacy,
            HTTP_400=BadRequestErrorResponseModel,
            HTTP_401=UnauthorizedErrorResponseModel,
            HTTP_404=NotFoundErrorResponseModel,
            HTTP_500=InternalServerErrorResponseModel,
    ...
    async def on_put(self, req, resp):
        """
        Control and configure the default (controller0) Bluetooth controller (legacy)
...
class BluetoothControllerLegacyResource:
    ...
    async def on_get(self, req, resp, controller):
        """
        Retrieve the state of a specific Bluetooth controller and its devices (legacy)
        """
        resp = await BluetoothRESTService.handle_get(
    ...
    async def on_put(self, req, resp, controller):
        """
        Control and configure a specific Bluetooth controller (legacy)
...
class BluetoothDeviceLegacyResource:
    ...
    async def on_get(self, req, resp, controller, device):
        """
        Retrieve the state of a specific Bluetooth controller and device (legacy)
        """
        resp = await BluetoothRESTService.handle_get(
