...
packages = []
environment_variable_value = os.environ.get("SUMMIT_RCM_BLUETOOTH_PLUGIN_EXTRA_PACKAGES", "")
...
def get_cython_options():
    ...
    modules_to_exclude = [
        "summit_rcm_bluetooth.rest_api.utils.spectree.models",
        "summit_rcm_bluetooth.rest_api.utils.spectree.tags",
    ]
...
def run_setup(CYTHON):
    ...
    setup(
        name="summit-rcm-bluetooth-plugin",
        cmdclass=cmdclass,
        version="1.0",
        packages=packages,
