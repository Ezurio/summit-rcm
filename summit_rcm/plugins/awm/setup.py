...
packages = []
environment_variable_value = os.environ.get("SUMMIT_RCM_AWM_PLUGIN_EXTRA_PACKAGES", "")
...
def get_cython_options():
    ...
    modules_to_exclude = ["summit_rcm_awm.rest_api.utils.spectree.models"]
